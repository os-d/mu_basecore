...
[Memory Type Information HOB](https://github.com/os-d/edk2/blob/pei_buckets/MdeModulePkg/Include/Guid/MemoryTypeInformation.h).
...
ensuring they live at a fixed address. See #OSDDEBUG_FILL_IN for information on how this can be tuned through
UefiBootManagerLib.
...
- Produce the
  [Install PEI Memory Bins PPI](https://github.com/os-d/edk2/blob/pei_buckets/MdeModulePkg/Include/Ppi/InstallPeiMemoryBins.h)
...
- Configure PEI core to be shadowed to memory via
  [PcdShadowPeimOnBoot](https://github.com/tianocore/edk2/blob/d78a2b52f3ddf7439bca063cc093d441b9e587f9/MdeModulePkg/MdeModulePkg.dec#L1402C34-L1402C53).
